...
AbstractPathPoint* GeometryPath::addPathPoint(const SimTK::State& s,
                                              int aIndex,
...
void GeometryPath::extendPreScale(const SimTK::State& s,
...
void GeometryPath::extendPostScale(const SimTK::State& s,
                                   const ScaleSet& scaleSet)
{
 ...
 */
double GeometryPath::calcLengthAfterPathComputation(
        const SimTK::State& s,
